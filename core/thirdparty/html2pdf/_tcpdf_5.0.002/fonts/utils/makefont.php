...
/**
 * 
 * @param Text $fontfile path to font file (TTF, OTF or PFB).
 * @param Text $fmfile font metrics file (UFM or AFM).
 * @param boolean $embedded Set to false to not embed the font, true otherwise (default).
 * @param Text $enc Name of the encoding table to use. Omit this parameter for TrueType Unicode, OpenType Unicode and symbolic fonts like Symbol or ZapfDingBats.
 ...
 * @param Text $enc map name (see /enc/ folder for valid names).
 */
