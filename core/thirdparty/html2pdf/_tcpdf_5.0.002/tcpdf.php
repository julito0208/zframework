...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		...
		/**
		 * @var Text to print as title on document header.
		 * @access protected
		 */
		protected $header_title = '';

		/**
		 * @var Text to print on document header.
		 * @access protected
		 */
		 ...
		 * @since 1.0
		 * @param Text $orientation page orientation. Possible values are (case insensitive):<ul><li>P or Portrait (default)</li><li>L or Landscape</li></ul>
		 * @param Text $unit User measure unit. Possible values are:<ul><li>pt: point</li><li>mm: millimeter (default)</li><li>cm: centimeter</li><li>in: inch</li></ul><br />A point equals 1/72 of inch, that is to say about 0.35 mm (an inch being 2.54 cm). This is a very common unit in typography; font sizes are expressed in that unit.
		 ...
		 * @param Text $encoding charset encoding; default is UTF-8
		 * @access public
		 */
		 ...
		 * @param Text $re regular expression (leave empty for default).
		 * @access public
		 ...
		 * @param Text $layout The page layout. Possible values are:<ul><li>SinglePage Display one page at a time</li><li>OneColumn Display the pages in one column</li><li>TwoColumnLeft Display the pages in two columns, with odd-numbered pages on the left</li><li>TwoColumnRight Display the pages in two columns, with odd-numbered pages on the right</li><li>TwoPageLeft (PDF 1.5) Display the pages two at a time, with odd-numbered pages on the left</li><li>TwoPageRight (PDF 1.5) Display the pages two at a time, with odd-numbered pages on the right</li></ul>
		 * @param Text $mode A name object specifying how the document should be displayed when opened:<ul><li>UseNone Neither document outline nor thumbnail images visible</li><li>UseOutlines Document outline visible</li><li>UseThumbs Thumbnail images visible</li><li>FullScreen Full-screen mode, with no menu bar, window controls, or any other window visible</li><li>UseOC (PDF 1.5) Optional content group panel visible</li><li>UseAttachments (PDF 1.6) Attachments panel visible</li></ul>
		 * @access public
		 * @since 1.2
		 */
		 ...
		 * @param Text $author The name of the author.
		 * @access public
		 * @since 1.2
		 ...
		 * @param Text $keywords The list of keywords.
		 * @access public
		 * @since 1.2
		 ...
		 * @param Text $creator The name of the creator.
		 * @access public
		 * @since 1.2
		 ...
		 * @param Text $msg The error message
		 * @access public
		 * @since 1.0
		 */
		 ...
		 * @param Text $orientation page orientation.
		...
		/**
	 	 * Set header data.
		 * @param Text $ln header image logo
		 * @param Text $lw header image logo width in mm
		 * @param Text $ht string to print as title on document header
		 * @param Text $hs string to print on document header
		 * @access public
		 */
		 ...
		 * @param Text $name name of the spot color
		 ...
		 * @param Text $s The string whose length is to be computed
		 * @param Text $fontname Family font. It can be either a name defined by AddFont() or one of the standard families. It is also possible to pass an empty string, in that case, the current family is retained.
		 * @param Text $fontstyle Font style. Possible values are (case insensitive):<ul><li>empty string: regular</li><li>B: bold</li><li>I: italic</li><li>U: underline</li><li>D: line-trough</li><li>O: overline</li></ul> or any combination. The default value is regular.
		 ...
		 * @param Text $sa The array of chars whose total length is to be computed
		 * @param Text $fontname Family font. It can be either a name defined by AddFont() or one of the standard families. It is also possible to pass an empty string, in that case, the current family is retained.
		 * @param Text $fontstyle Font style. Possible values are (case insensitive):<ul><li>empty string: regular</li><li>B: bold</li><li>I: italic</li><li>U: underline</li><li>D: line trough</li><li>O: overline</li></ul> or any combination. The default value is regular.
		 * @param float $fontsize Font size in points. The default value is the current size.
		 * @param boolean $getarray if true returns an array of characters widths, if false returns the total length.
		 ...
		 * @param Text $family Font family. The name can be chosen arbitrarily. If it is a standard family name, it will override the corresponding font.
		 * @param Text $style Font style. Possible values are (case insensitive):<ul><li>empty string: regular (default)</li><li>B: bold</li><li>I: italic</li><li>BI or IB: bold italic</li></ul>
		 * @param Text $fontfile The font definition file. By default, the name is built from the family and style, in lower case with no spaces.
		 ...
		 * @param Text $font font name
		 * @param Text $style font style
		 * @param float $size The size (in points)
		 ...
		 * @param float $w Width of the rectangle
		 * @param float $h Height of the rectangle
		 * @param Text $text annotation text or alternate content
		 ...
		 * @param Text $txt String to print
		 ...
		 * @param Text $align Allows to center or align the text. Possible values are:<ul><li>L or empty string: left align (default value)</li><li>C: center</li><li>R: right align</li><li>J: justify</li></ul>
		 ...
		 * @param Text $calign cell vertical alignment relative to the specified Y value. Possible values are:<ul><li>T : cell top</li><li>A : font top</li><li>L : font baseline</li><li>D : font bottom</li><li>B : cell bottom</li></ul>
		 * @param Text $valign text vertical alignment inside the cell. Possible values are:<ul><li>T : top</li><li>C : center</li><li>B : bottom</li></ul>
		 ...
		 * @param float $h Cell height. Default value: 0.
		 * @param Text $txt String to print. Default value: empty string.
		 * @param mixed $border Indicates if borders must be drawn around the cell. The value can be either a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul>or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul>
		...
		* Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		 ...
		 * @param int $stretch stretch carachter mode: <ul><li>0 = disabled</li><li>1 = horizontal scaling only if necessary</li><li>2 = forced horizontal scaling</li><li>3 = character spacing only if necessary</li><li>4 = forced character spacing</li></ul>
		 * @param boolean $ignore_min_height if true ignore automatic minimum height value.
		 * @param Text $calign cell vertical alignment relative to the specified Y value. Possible values are:<ul><li>T : cell top</li><li>C : center</li><li>B : cell bottom</li><li>A : font top</li><li>L : font baseline</li><li>D : font bottom</li></ul>
		 * @param Text $valign text vertical alignment inside the cell. Possible values are:<ul><li>T : top</li><li>C : center</li><li>B : bottom</li></ul>
		 * @access public
		 * @since 1.0
		 ...
		 * @param Text $txt input string
		 * @return Text without SHY characters.
		 * @access public
		 ...
		 * @param Text $align Allows to center or align the text. Possible values are:<ul><li>L or empty string: left align</li><li>C: center</li><li>R: right align</li><li>J: justification (default value when $ishtml=false)</li></ul>
		 * @param int $fill Indicates if the cell background must be painted (1) or transparent (0). Default value: 0.
		 ...
		 * @param Text $strarr The input array of characters.
		 ...
		 * @param Text $uniarr The input array of characters.
		 * @param int $start the starting element of $strarr.
		 * @param int $end first element that will not be returned.
		 * @return Return part of a string
		 * @access public
		 ...
		 * @param Text $ta The input array of UTF8 values.
		 ...
		 * @param Text $imgfile image file name
		 ...
		 * @param Text $file Name of the file containing the image.
		 * @param float $x Abscissa of the upper-left corner.
		 * @param float $y Ordinate of the upper-left corner.
		 * @param float $w Width of the image in the page. If not specified or equal to zero, it is automatically calculated.
		 * @param float $h Height of the image in the page. If not specified or equal to zero, it is automatically calculated.
		 * @param Text $type Image format. Possible values are (case insensitive): JPEG and PNG (whitout GD library) and all images supported by GD: GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM;. If not specified, the type is inferred from the file extension.
		 * @param mixed $link URL or identifier returned by AddLink().
		 * @param Text $align Indicates the alignment of the pointer next to image insertion relative to image height. The value can be:<ul><li>T: top-right for LTR or top-left for RTL</li><li>M: middle-right for LTR or middle-left for RTL</li><li>B: bottom-right for LTR or bottom-left for RTL</li><li>N: next line</li></ul>
		 ...
		 * @param Text $palign Allows to center or align the image on the current line. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
		 ...
		 * @param Text $file Image file name.
		 ...
		 * @param Text $file image file to parse
		 ...
		 * @param Text $name The name of the file when saved. Note that special characters are removed and blanks characters are replaced with the underscore character.
		 * @param Text $dest Destination where to send the document. It can take one of the following values:<ul><li>I: send the file inline to the browser (default). The plug-in is used if available. The name given by name is used when one selects the "Save as" option on the link generating the PDF.</li><li>D: send to the browser and force a file download with the name given by name.</li><li>F: save to a local server file with the name given by name.</li><li>S: return the document as a string. name is ignored.</li><li>FI: equivalent to F + I option</li><li>FD: equivalent to F + D option</li></ul>
		 * @access public
		 * @since 1.0
		 * @see Close()
		 */
		 ...
		 * @param Text $stream appearance stream
		 ...
		 * @return Text for viewer preferences
		 * @author Nicola asuni
		 * @since 3.1.000 (2008-06-09)
		 * @access protected
		 */
		 ...
		 * @param Text $txt text to underline
		 * @access protected
		 */
		 ...
		 * @param int $x X coordinate
		 * @param int $y Y coordinate
		 * @param Text $txt text to linethrough
		 * @access protected
		 */
		 ...
		 * @param int $x X coordinate
		 * @param int $y Y coordinate
		 * @param Text $txt text to overline
		 * @access protected
		 ...
		 * @param Text $s data string to escape.
		 * @return Text escaped string.
		 * @access protected
		 */
		 ...
		 * @return Text escaped date string.
		 * @access protected
		 * @since 4.6.028 (2009-08-25)
		 */
		 ...
		 *   ---------------------------------------------------------------------
		 * </pre>
		 * @param Text $str string to process.
		...
		/**
		 * Output anchor link.
		 * @param Text $url link URL or internal link (i.e.: &lt;a href="#23"&gt;link to page 23&lt;/a&gt;)
		 * @param Text $name link name
		 * @param int $fill Indicates if the cell background must be painted (1) or transparent (0). Default value: 0.
		 * @param boolean $firstline if true prints only the first line and return the remaining string.
		 * @param array $color array of RGB text color
		 * @param Text $style font style (U, D, B, I)
		 * @param boolean $firstblock if true the string is the starting of a line.
		 ...
		 * @param Text $key encryption key
		 * @param Text $text input text to be encrypted
		 ...
		 * @return Text MD5 encrypted binary string
		 * @access protected
		 * @since 2.0.000 (2008-01-02)
		 * @author Klemen Vodopivec
		 */
		 ...
		 * @param Text $user_pass user password
		 * @param Text $owner_pass user password
		 * @return Text O value
		 * @access protected
		 * @since 2.0.000 (2008-01-02)
		 * @author Klemen Vodopivec
		 ...
		 * @param Text $user_pass user password
		 * @param Text $owner_pass user password
		 * @param Text $protection protection type
		 * @access protected
		 * @since 2.0.000 (2008-01-02)
		 * @author Klemen Vodopivec
		 */
		 ...
		 * @param Text $user_pass user password. Empty by default.
		 * @param Text $owner_pass owner password. If not specified, a random value is used.
		 * @access public
		 * @since 2.0.000 (2008-01-02)
		 * @author Klemen Vodopivec
		 */
		 ...
		 * @param float $w Width.
		 * @param float $h Height.
		 * @param Text $style Style of rendering. See the getPathPaintOperator() function for more information.
		 ...
		 * @param array $fill_color Fill color. Format: array(red, green, blue). Default value: default color (empty array).
		 * @param Text $circle_style Style of rendering of inscribed circle (if draws). Possible values are:
		 * <ul>
		 ...
		 * @param Text $round_corner Draws rounded corner or not. String with a 0 (not rounded i-corner) or 1 (rounded i-corner) in i-position. Positions are, in order and begin to 0: top left, top right, bottom right and bottom left. Default value: all rounded corner ("1111").
		 * @param Text $style Style of rendering. See the getPathPaintOperator() function for more information.
		 * @param array $border_style Border style of rectangle. Array like for {@link SetLineStyle SetLineStyle}. Default value: default line style (empty array).
		 * @param array $fill_color Fill color. Format: array(GREY) or array(R,G,B) or array(C,M,Y,K). Default value: default color (empty array).
		 * @access public
		 ...
		 * @param Text $str string to manipulate.
		 ...
		 * @param Text $str string to manipulate (or empty value).
		 * @param bool $setbom  if true set the Byte Order Mark (BOM = 0xFEFF)
		 * @param bool $forcertl if true forces RTL text direction
		 * @return Text
		 * @access protected
		...
		/**
		 * Adds a bookmark.
		 * @param Text $txt bookmark description.
		...
		/**
		 * Adds a javascript
		 * @param Text $script Javascript code
		 * @access public
		 ...
		 * @param Text $color color name or #RRGGBB
		 * @access protected
		 ...
		 * @param array $prop javascript field properties. Possible values are described on official Javascript for Acrobat API reference.
		 * @param array $opt annotation parameters. Possible values are described on official PDF32000_2008 reference.
		 * @param Text $onvalue value to be returned if selected.
		 ...
		 * @param Text $document Names specifying additional document-wide usage rights for the document. The only defined value is "/FullSave", which permits a user to save the document along with modified form and/or annotation data.
		 * @param Text $annots Names specifying additional annotation-related usage rights for the document. Valid names in PDF 1.5 and later are /Create/Delete/Modify/Copy/Import/Export, which permit the user to perform the named operation on annotations.
		 * @param Text $form Names specifying additional form-field-related usage rights for the document. Valid names are: /Add/Delete/FillIn/Import/Export/SubmitStandalone/SpawnTemplate
		 * @param Text $signature Names specifying additional signature-related usage rights for the document. The only defined value is /Modify, which permits a user to apply a digital signature to an existing signature form field or clear a signed signature form field.
		 * @access public
		 * @author Nicola Asuni
		 * @since 2.9.000 (2008-03-26)
		 */
		 ...
		 * @param Text $private_key_password password
		 * @param Text $extracerts specifies the name of a file containing a bunch of extra certificates to include in the signature which can for example be used to help the recipient to verify the certificate that you used.
		 ...
		 * @param Text $v visibility mode. Legal values are: all, print, screen.
		 * @access public
		 * @since 3.0.000 (2008-03-27)
		 */
		 ...
		 * @param Text $bm blend mode, one of the following: Normal, Multiply, Screen, Overlay, Darken, Lighten, ColorDodge, ColorBurn, HardLight, SoftLight, Difference, Exclusion, Hue, Saturation, Color, Luminosity
		 * @access public
		 * @since 3.0.000 (2008-03-27)
		 */
		 ...
		 * @param Text $colors colors to print, one letter per color separated by comma (for example 'A,W,R,G,B,C,M,Y,K'): A=black, W=white, R=red, G=green, B=blue, C=cyan, M=magenta, Y=yellow, K=black.
		 * @author Nicola Asuni
		 ...
		 * @param Text $type type of crop mark, one sybol per type separated by comma: A = top left, B = top right, C = bottom left, D = bottom right.
		...
		/**
	 	 ...
	 	 * @param Text $code code to print
	 	 * @param Text $type type of barcode (see barcodes.php for supported formats).
		 ...
		 * @param Text $align Indicates the alignment of the pointer next to barcode insertion relative to barcode height. The value can be:<ul><li>T: top-right for LTR or top-left for RTL</li><li>M: middle-right for LTR or middle-left for RTL</li><li>B: bottom-right for LTR or bottom-left for RTL</li><li>N: next line</li></ul>
		 * @author Nicola Asuni
		 * @since 3.1.000 (2008-06-09)
		 * @access public
		 */
		 ...
		 * @param Text $type type of barcode (I25, C128A, C128B, C128C, C39)
		 * @param Text $style barcode style
		 * @param Text $font font for text
		...
		/**
	 	 * Print 2D Barcode.
	 	 * @param Text $code code to print
	 	 * @param Text $type type of barcode (see 2dbarcodes.php for supported formats).
		 * @param int $x x position in user units
		 * @param int $y y position in user units
		 * @param int $w width in user units
		 * @param int $h height in user units
		 ...
		 * @return Text current font family name
		 * @access public
		 ...
		 * @return Text current font style
		 * @access public
		 * @since 4.3.008 (2008-12-05)
		 */
		 ...
		 * @param Text $html html text to print. Default value: empty string.
		 * @param mixed $border Indicates if borders must be drawn around the cell. The value can be either a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul>or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul>
	...
	* Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		 * @param int $fill Indicates if the cell background must be painted (1) or transparent (0). Default value: 0.
		 * @param boolean $reseth if true reset the last cell height (default true).
		 * @param Text $align Allows to center or align the text. Possible values are:<ul><li>L : left align</li><li>C : center</li><li>R : right align</li><li>'' : empty string : left for LTR or right for RTL</li></ul>
		 * @param boolean $autopadding if true, uses internal padding and automatically adjust it to account for line width.
		 * @access public
		 * @uses MultiCell()
		 ...
		 * @param Text $hbz Distance between current y and line bottom.
		 * @param Text $hb The height of the break.
		 * @param boolean $cell if true add the default cMargin space to each new line (default false).
		 ...
		 * @param Text $symbol character or string to be used (legal values are: '' = automatic, '!' = auto bullet, '#' = auto numbering, 'disc', 'disc', 'circle', 'square', '1', 'decimal', 'decimal-leading-zero', 'i', 'lower-roman', 'I', 'upper-roman', 'a', 'lower-alpha', 'lower-latin', 'A', 'upper-alpha', 'upper-latin', 'lower-greek')
		 * @access public
		 * @since 4.0.028 (2008-09-26)
		 */
		 ...
		 * @param Text $fontstyle additional font styles to add
		 * @access public
		 * @since 4.4.003 (2008-12-09)
		 */
		 ...
		 * @param Text $htmlval string containing values and unit
		 * @param Text $refsize reference value in points
		 * @param Text $defaultunit default unit (can be one of the following: %, em, ex, px, in, mm, pc, pt).
		 ...
		 * @return Text roman representation of the specified number
		 * @access public
		 * @since 4.4.004 (2008-12-10)
		 */
		 ...
		 * @param Text $listtype type of list
		 ...
		 * @param Text $prefix prefix to add to filename
		 ...
		 * @param int $page page number
		 * @return Text page buffer content or false in case of error
		 * @access protected
		 * @since 4.5.000 (2008-12-31)
		 */
		 ...
		 * @param Text $image image key
		 * @return Text image buffer content or false in case of error
		 * @access protected
		 * @since 4.5.000 (2008-12-31)
		 */
		 ...
		 * @param Text $font font key
		 * @return Text font buffer content or false in case of error
		 * @access protected
		 * @since 4.5.000 (2009-01-02)
		 */
		 ...
		 * @param Text $numbersfont set the font for page numbers (please use monospaced font for better alignment).
		 * @param Text $filler string used to fill the space between text and page number.
		 * @param Text $toc_name name to use for TOC bookmark.
		 * @access public
		 * @author Nicola Asuni
		 * @since 4.5.000 (2009-01-02)
		 ...
		 * @param Text $haystack The string to search in.
		 * @param Text $needle substring to search.
		 ...
		 * @param Text $file TEX file containing hypenation patterns. TEX pattrns can be downloaded from http://www.ctan.org/tex-archive/language/hyph-utf8/tex/generic/hyph-utf8/patterns/
		 ...
		 * @param Text $text text to process
		 ...
		 * @param Text $style Style of rendering. Possible values are:
		 * <ul>
		 ...
		 * </ul>
		 * @param Text $default default style
		 * @param boolean $mode if true enable rasterization, false otherwise.
		 * @author Nicola Asuni
		 * @access protected
		 ...
		 * @param Text $file Name of the SVG file.
		 * @param float $x Abscissa of the upper-left corner.
		 * @param float $y Ordinate of the upper-left corner.
		 * @param float $w Width of the image in the page. If not specified or equal to zero, it is automatically calculated.
		 * @param float $h Height of the image in the page. If not specified or equal to zero, it is automatically calculated.
		 ...
		 * @param Text $clip_function clip function
		...
		/**
		 * Draws an SVG path
		 * @param Text $d attribute d of the path SVG element
		 * @param Text $style Style of rendering. Possible values are:
		 * <ul>
		 *	 <li>D or empty string: Draw (default).</li>
		 *	 <li>F: Fill.</li>
		 ...
		 * @param Text $name The second parameter, name, contains the name of the element for which this handler is called. If case-folding is in effect for this parser, the element name will be in uppercase letters. 
		 ...
		 * Sets the character data handler function for the XML parser.
		 * @param resource $parser The first parameter, parser, is a reference to the XML parser calling the handler.
		 * @param Text $data The second parameter, data, contains the character data as a string. 
		 * @author Nicola Asuni
		 * @since 5.0.000 (2010-05-02)
		 * @access protected
		 */
