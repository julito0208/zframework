...
if (!class_exists('QRcode', false)) {
	...
	class QRcode {
		 ...
		 * @param Text $code code to represent using QRcode
		 * @param Text $eclevel error level: <ul><li>L : About 7% or less errors can be corrected.</li><li>M : About 15% or less errors can be corrected.</li><li>Q : About 25% or less errors can be corrected.</li><li>H : About 30% or less errors can be corrected.</li></ul>
		 * @access public
		 * @since 1.0.000
		 */
		 ...
		 * @param Text $string input string to encode
		 */
		 ...
		 * @param int $x X position
		 * @param int $y Y position
		 * @param Text $repl value to replace
