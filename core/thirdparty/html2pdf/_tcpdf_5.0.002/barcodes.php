...
class TCPDFBarcode {
	 ...
	 * @param Text $code code to represent.
	 ...
	 * @param Text $code code to process.
	 * @return int checksum.
	 * @access protected
	 */
	 ...
	 * @param Text $seq barcode as binary sequence
	 ...
	 * @param Text $code code to represent.
	 * @param Text $type barcode type: A, B or C
	 * @return array barcode representation.
	 * @access protected
	 */
	 ...
	 * @param Text $code code to represent.
	 * @param Text $len barcode type: 6 = UPC-E, 8 = EAN8, 13 = EAN13, 12 = UPC-A
	 * @return array barcode representation.
	 * @access protected
	 */
	 ...
	 * @param Text $code code to represent.
	 * @param Text $len barcode type: 2 = 2-Digit, 5 = 5-Digit
	 * @return array barcode representation.
	 * @access protected
	 */
	 ...
	 * @param Text $code zip code to represent. Must be a string containing a zip code of the form DDDDD or DDDDD-DDDD.
	 ...
	 * @param Text $code code to print, separate the ZIP (routing code) from the rest using a minus char '-' (BarcodeID_ServiceTypeID_MailerID_SerialNumber-RoutingCode)
	 * @return array barcode representation.
	 * @access protected
	 */
	 ...
	 * (requires PHP bcmath extension) 
	 * @param Text $number number to convert specified as a string
	 * @return Text hexadecimal representation
	 */
	 ...
	 * (requires PHP bcmath extension) 
	 * @param Text $hex hexadecimal number to convert specified as a string
	 * @return Text hexadecimal representation
	 */
	 ...
	 * @param Text $code_arr array of hexadecimal values (13 bytes holding 102 bits right justified).
