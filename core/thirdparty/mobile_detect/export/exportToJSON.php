 ...
 * =====================
 *
 * Use the resulting JSONMap export file in other languages
 * other than PHP. Always check for 'version' key because
 * new major versions can modify the structure of the JSONMap file.
 *
...
// Included nicejson function to beautify the result JSONMap file.
...
// Write the JSONMap file to disk.
