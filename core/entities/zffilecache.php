...
class ZfFileCache extends ZfFileDatabase
{

	/* ZPHP Generated Code ------------------------------------------ */


	private static $_CACHE_MANAGER_KEY_GET_PREFIX = "cache_ZfFileentity_get_by_";

	private static function _generate_cache_key_get_by_id_file($id_file) {
		$values = func_get_args();
		return self::$_CACHE_MANAGER_KEY_GET_PREFIX.'id_file_'.implode('_', $values);
	}
	...
	private static function _cache_save($entity) {
		if($entity) {
			CacheManager::save(self::_generate_cache_key_get_by_id_file($entity->get_id_file()), $entity);
		}
	...
	private static function _cache_delete($entity) {
		if($entity) {
			CacheManager::delete(self::_generate_cache_key_get_by_id_file($entity->get_id_file()));
		}
	...
	*/
	public static function get_by_id_file($id_file, $column=null) {
		$entity = CacheManager::get(self::_generate_cache_key_get_by_id_file($id_file));

		if(!$entity) {
			$entity = parent::get_by_id_file($id_file);
