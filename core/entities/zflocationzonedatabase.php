...
class ZfLocationZoneDatabase extends DBEntity
{

	/* ZPHP Generated Code ------------------------------------------ */

	const ENTITY_TABLE = '`zf_location_zone`';
	...
	*/
	public static function get_by_id_zone($id_zone, $column=null) {
		...
		return ZfLocationZone::get_row(array('id_zone' => $id_zone), $column);
	...
	*/	
	...
	public static function list_by_id_city($id_city, $conditions=null, $order=null, $limit=null) {


		return ZfLocationZone::list_all(array_merge(array('id_city' => $id_city), (array) $conditions), $order, $limit);

	}
	
	public static function count_by_id_city($id_city, $conditions=null) {


		return ZfLocationZone::count_all(array_merge(array('id_city' => $id_city), (array) $conditions));

	}
	
	public static function list_by_id_parent_zone($id_parent_zone, $conditions=null, $order=null, $limit=null) {


		return ZfLocationZone::list_all(array_merge(array('id_parent_zone' => $id_parent_zone), (array) $conditions), $order, $limit);

	}
	
	public static function count_by_id_parent_zone($id_parent_zone, $conditions=null) {


		return ZfLocationZone::count_all(array_merge(array('id_parent_zone' => $id_parent_zone), (array) $conditions));
	...
	*/
	public static function saveEntity(ZfLocationZone $entity) {
		...
		$primary_keys_values['id_zone'] = $entity_row['id_zone'];
		...
		if(DBConnection::get_default_connection()->select_value('SELECT COUNT(*) FROM '.self::ENTITY_TABLE.' '.SQLHelper::prepare_conditions($primary_keys_values, true)) == 1) {
			...
			DBConnection::get_default_connection()->query_update('zf_location_zone', $entity_row, $primary_keys_values);

		} else {

			DBConnection::get_default_connection()->query_insert('zf_location_zone', $entity_row, true);
			$primary_keys_values['id_zone'] = DBConnection::get_default_connection()->get_insert_id();
			$entity->id_zone = $primary_keys_values['id_zone'];
	...
	public static function __callStatic($method, $args)
	{
		if($method == 'save')
		{
			call_user_func_array(array('ZfLocationZone', 'saveEntity'), $args);
		}
		else
		{
	...
	public function __construct($data = null) {
		...
		if($data !== null) {
			...
			if(is_array($data) || (is_object($data) && $data instanceof DBEntity)) {
				...
				$entity = ZfLocationZone::get_row($conditions);
	...
	public function __call($method, $args)
	{
		if($method == 'save')
		{
			ZfLocationZone::saveEntity($this);
		}
		else
		{
	...
	* @return ZfLocationZone
	*/
	public function set_id_zone($value) {
		$this->_id_zone = $value;
		return $this;
	}
	...
	*/
	...
	public function get_id_parent_zone() {
		return $this->_id_parent_zone;
	}
	...
	* @return ZfLocationZone
	*/
	public function set_id_parent_zone($value) {
		$this->_id_parent_zone = $value;
		return $this;
	}
