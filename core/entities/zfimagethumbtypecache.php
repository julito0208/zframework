...
class ZfImageThumbTypeCache extends ZfImageThumbTypeDatabase
{
	...
	protected static $_CACHE_MANAGER_KEY_GET_PREFIX = "cache_zfimagethumbtypeentity_get_by_";

	protected static function _generate_cache_key_get_by_id_image_thumb_type($id_image_thumb_type) {
