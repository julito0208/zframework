...
class ZfImageTypeCache extends ZfImageTypeDatabase
{
	...
	private static $_CACHE_MANAGER_KEY_GET_PREFIX = "cache_zfimagetypeentity_get_by_";

	private static function _generate_cache_key_get_by_id_image_type($id_image_type) {
