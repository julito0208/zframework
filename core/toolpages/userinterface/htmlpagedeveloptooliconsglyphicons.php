...
class HTMLPageDevelopToolIconsGlyphicons extends HTMLPageDevelopToolIcons  {

	const URL_SCRIPT_PATTERN = '/icons\/gylph(?:\.php)?';
	const THEME = 'glyphicons';

	/*----------------------------------------------*/

	protected static function _get_names()
	{
		$icons = array(
			'glyphicon-asterisk',
			'glyphicon-plus',
...
//		sort($icons);
	...
	public function prepare_params() {
		...
		$this->set_param('names', self::_get_names());
	}
}
