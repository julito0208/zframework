...
return Sizzle;});define("tinymce/util/Tools",[],function(){var whiteSpaceRegExp=/^\s*|\s*$/g;function trim(str){return(str===null||str===undefined)?'':(""+str).replace(whiteSpaceRegExp,'');}
