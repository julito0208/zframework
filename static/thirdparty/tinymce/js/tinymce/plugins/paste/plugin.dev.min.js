...
exports.define=define;exports.require=require;expose(["tinymce/pasteplugin/Utils","tinymce/pasteplugin/WordFilter"]);load('classes/Utils.js');load('classes/Clipboard.js');load('classes/WordFilter.js');load('classes/Quirks.js');load('classes/Plugin.js');writeScripts();})(this);